...
function verificarPermissoesUI() {
    ...
    if (panelBadgesContainer) {
        ...
        if (usuarioAtual.dualCargo) {
            ...
            const textoBadge = usuarioAtual.cargo || labels[usuarioAtual.nivelAcesso] || 'Desconhecido'

            badgesHTML = `<span class="panel-badge ${badgeClass}">${textoBadge}</span>`
        }
